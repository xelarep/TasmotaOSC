...
Just download, edit the config to your needs, copy&paste to the Berry console and run!

Tested on a NOUS A8T WiFi Plug, tasmota32, 13.2.0 and 15.2.0 with console ttols, Protokol and Gig Performer.
